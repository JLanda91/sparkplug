...
#include <sparkplug/util/concepts/functor_template_constructible_with_pointers.hpp>
...
class FunctorTest : public ::testing::Test {
    static_assert(util::concepts::FunctorTemplateConstructibleWithPointers<FunctorTemplate, typename detail::proxy<Deps>::callable...>,
